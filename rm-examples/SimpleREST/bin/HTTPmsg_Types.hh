...
class Send__failed {
  HTTPMessage field_msg;
  BOOLEAN field_already__half__closed;
public:
  Send__failed();
  Send__failed(const HTTPMessage& par_msg,
    const BOOLEAN& par_already__half__closed);
  Send__failed(const Send__failed& other_value);
  inline boolean is_component() { return FALSE; }
  void clean_up();
const TTCN_Typedescriptor_t* get_descriptor() const;
  Send__failed& operator=(const Send__failed& other_value);
  boolean operator==(const Send__failed& other_value) const;
  inline boolean operator!=(const Send__failed& other_value) const
    { return !(*this == other_value); }
...
inline boolean is_present() const { return is_bound(); }
  ...
  inline HTTPMessage& msg()
    {return field_msg;}
  inline const HTTPMessage& msg() const
    {return field_msg;}
  inline BOOLEAN& already__half__closed()
    {return field_already__half__closed;}
  inline const BOOLEAN& already__half__closed() const
    {return field_already__half__closed;}
  inline int size_of() const
    {return 2;}
  void log() const;
...
class Send__failed_template : public Base_Template {
struct single_value_struct;
union {
single_value_struct *single_value;
struct {
unsigned int n_values;
Send__failed_template *list_value;
} value_list;
};

void set_specific();
void copy_value(const Send__failed& other_value);
void copy_template(const Send__failed_template& other_value);

public:
Send__failed_template();
Send__failed_template(template_sel other_value);
Send__failed_template(const Send__failed& other_value);
Send__failed_template(const OPTIONAL<Send__failed>& other_value);
Send__failed_template(const Send__failed_template& other_value);
~Send__failed_template();
Send__failed_template& operator=(template_sel other_value);
Send__failed_template& operator=(const Send__failed& other_value);
Send__failed_template& operator=(const OPTIONAL<Send__failed>& other_value);
Send__failed_template& operator=(const Send__failed_template& other_value);
boolean match(const Send__failed& other_value, boolean legacy = FALSE) const;
boolean is_bound() const;
boolean is_value() const;
void clean_up();
Send__failed valueof() const;
void set_type(template_sel template_type, unsigned int list_length);
Send__failed_template& list_item(unsigned int list_index) const;
HTTPMessage_template& msg();
const HTTPMessage_template& msg() const;
BOOLEAN_template& already__half__closed();
const BOOLEAN_template& already__half__closed() const;
int size_of() const;
void log() const;
void log_match(const Send__failed& match_value, boolean legacy = FALSE) const;
void encode_text(Text_Buf& text_buf) const;
void decode_text(Text_Buf& text_buf);
void set_param(Module_Param& param);
void check_restriction(template_res t_res, const char* t_name=NULL, boolean legacy = FALSE) const;
...
extern const TTCN_OERdescriptor_t HTTPResponse__binary__body_body_oer_;
...
extern const TTCN_OERdescriptor_t HTTPRequest__binary__body_body_oer_;
...
extern const TTCN_OERdescriptor_t Connect_use__ssl_oer_;
...
extern const TTCN_OERdescriptor_t Listen_use__ssl_oer_;
...
extern const XERdescriptor_t Send__failed_already__half__closed_xer_;
extern const TTCN_OERdescriptor_t Send__failed_already__half__closed_oer_;
extern const TTCN_Typedescriptor_t Send__failed_already__half__closed_descr_;
extern const TTCN_Typedescriptor_t Send__failed_descr_;
