...
public interface FileStoreValueRepo extends JpaRepository<FileStoreValue, FileStoreValuePK> {
	...
	FileStoreValue findTop1ByFileStoreValueIdFileStoreValueFileStoreFileStoreUuidAndFileStoreValueIdFileStoreValueMeasurementIdOrderByFileStoreValueIdFileStoreValueTimestampAsc(String fileStoreUuid, Long measurementId);
	FileStoreValue findTop1ByFileStoreValueIdFileStoreValueFileStoreFileStoreUuidAndFileStoreValueIdFileStoreValueMeasurementIdOrderByFileStoreValueIdFileStoreValueTimestampDesc(String fileStoreUuid, Long measurementId);
}
