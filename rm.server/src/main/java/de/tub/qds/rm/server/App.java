package de.tub.qds.rm.server;

import de.tub.qds.rm.server.handler.HardwareIF;
import de.tub.qds.rm.server.handler.OperatingSystemIF;
import de.tub.qds.rm.server.handler.SystemIF;
...
public class App {
	public static void main( String[] args )
    {
    	...
    	server.addHttpListener(port, "localhost", handler);
		server.build().start();
